...
pub const USERDATA_UPDATE_TIME_SECONDS: u64 = 5; // blocks data updates for ten seconds after any previous on
pub const WATCHER_REACTION_TIME_SECONDS: u64 = 5; // After an event is detected of user's data folder, how many time to wait before uploading it
pub const ENCRYPTION_ALGORITHM: &str = "twofish"; // either: aes, serpent, twofish, chacha
